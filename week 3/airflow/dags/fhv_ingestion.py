...
URL_TEMPLATE = URL_PREFIX + '/fhvhv_tripdata_{{ execution_date.strftime(\'%Y-%m\') }}.parquet'
# OUTPUT_FILE_TEMPLATE = AIRFLOW_HOME + '/output_{{ execution_date.strftime(\'%Y-%m\') }}.parquet'
OUTPUT_FILE = 'output_fhvhv_{{ execution_date.strftime(\'%Y-%m\') }}.parquet'
...
local_workflow = DAG(
    dag_id="fhvhv_ingestion_gcs_dag",
